...
It's been a fun ride with unique challenges and [as I move on to my next post](https://healthprize.com/about-us/press-releases/healthprize-technologies-announces-new-chief-technology-officer/), I wanted to capture a few takeaways for posterity:

*  **Don't rewrite.** Just don't. While I certainly [agree with what Joel says about this](https://www.joelonsoftware.com/2000/04/06/things-you-should-never-do-part-i/), I'll add one more point of support - that a rewrite is a fight on two fronts. It's up against the formidable foes of [customer adoption of a new thing](https://smile.amazon.com/Who-Moved-My-Cheese-Amazing/dp/0399144463) and the golden project phenomenon - where a golden (too big to fail) project's scope continually increases without bound.
